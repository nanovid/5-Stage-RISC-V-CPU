...
```bash
git clone ist-git@git.uwaterloo.ca:ece621-f25/project/v2sharda-pd5.git
```
...
5. Ensure that your core executes all [rv32-benchmarks](https://git.uwaterloo.ca/ece621-f25/rv32-benchmarks) correctly.
